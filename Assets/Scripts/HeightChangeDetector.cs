...
public class HeightChangeDetector : MonoBehaviour // [TODO] consider moving this component to the character and platform
{                                                 // , since their collider would be always enabled
